(() => {
  ...
  const en = {
    ...
    "Dọn dẹp máy": "Clean up the PC", "Kiểm tra rồi chọn mục cần xóa.": "Check and choose what to delete.",
    "Kiểm tra": "Check", "Xóa mục đã chọn": "Delete selected item", "Chưa chọn mục nào": "No items selected",
    ...
    "WinAssist sẽ yêu cầu cập nhật khi phiên bản đang dùng đã cũ.": "WinAssist requires an update when the installed version is outdated.",
    "Thông báo cập nhật bắt buộc hiện ngay khi mở ứng dụng.": "A required update notice appears when the app opens.",
    "Có thể tải và cài bản mới trực tiếp trong WinAssist.": "Download and install the new version directly in WinAssist.",
    "Chỉ khóa ứng dụng khi bộ cài chính thức đã sẵn sàng; mất mạng không làm khóa nhầm.": "The app is locked only when an official installer is ready; an offline check will not lock it by mistake.",
