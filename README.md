...
**WinAssist 0.11.4.1 Community Beta** sửa vòng lặp kiểm tra mạng và hoàn thiện
quá trình cài Local AI ngay trong ứng dụng. Người dùng được hỏi trước, thấy tiến
trình tải và có thể ẩn popup để tiếp tục dùng WinAssist.

Nếu Ollama hoặc model phù hợp đã có trên máy, WinAssist tự nhận diện và không
tải lại. Việc chọn model dựa trên RAM và không yêu cầu người dùng biết tên model.
...
Mục **Có gì mới?** hiển thị đúng nội dung của bản `0.11.4.1` và lấy ngày phát hành
