...
ENGLISH_TEXT = {
    ...
    "Đây là những ứng dụng cơ bản nhiều người thường cài. Chọn một ứng dụng để WinAssist kiểm tra và chuẩn bị cài đặt.": "Here are common apps many people install. Choose one for WinAssist to check and prepare for installation.",
    "Google Chrome": "Google Chrome", "7-Zip": "7-Zip", "VLC": "VLC", "Adobe Reader": "Adobe Reader", "Zoom": "Zoom",
    "Xem tất cả ứng dụng": "View all apps", "Cài Google Chrome": "Install Google Chrome",
    "Cài 7-Zip": "Install 7-Zip", "Cài VLC": "Install VLC", "Cài Adobe Reader": "Install Adobe Reader", "Cài Zoom": "Install Zoom",
